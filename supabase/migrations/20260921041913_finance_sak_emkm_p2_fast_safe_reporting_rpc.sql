...
security invoker
set search_path=''
as $$ select private.get_finance_reporting_pack_v1(p_brand); $$;
...
security invoker
set search_path=''
as $$ select private.get_finance_period_pack_v1(p_brand,p_period); $$;

revoke all on function private.get_finance_reporting_pack_v1(uuid) from public;
revoke all on function private.get_finance_period_pack_v1(uuid,date) from public;
grant execute on function private.get_finance_reporting_pack_v1(uuid) to authenticated;
grant execute on function private.get_finance_period_pack_v1(uuid,date) to authenticated;
