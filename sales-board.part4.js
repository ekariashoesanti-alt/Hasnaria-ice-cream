EESE=2|ODENG TIPIS=2|Topokki=5|BAKSO UDANG=1|CHIKUWA=1|KUAH ODENG=2|SCALLOP=1|ICE CREAM BOWL=1', cash: 132000, qris: 0, tf: 0 },
  ...
  function css() {
    ...
    var s = document.createElement('style'); s.id = 'sales-board-css'; s.textContent =
      ...
      '.sb-left-stack{display:flex;flex-direction:column;gap:12px;min-width:0}' +
      '.sb-hourly-average{width:100%;box-sizing:border-box}' +
      '.sb-hourly-chart{min-height:180px}' +
      '.sb-hour-trend{fill:none;stroke:#176b55;stroke-width:2.5}' +
      '.sb-hour-point{fill:#176b55}' +
      '.sb-hour-point.peak{fill:#dc2626;stroke:#fecaca;stroke-width:3}' +
      '.sb-hour-peak-label{fill:#ecfdf5;stroke:#a7f3d0}' +
      '.sb-hour-peak-text{font-size:10px;fill:#065f46;font-weight:800}' +
      '.sb-hourly-empty{line-height:1.6}' +
      ...
      '.sb-bar-fill.worst{background:#d97706}' + '.sb-top-seller .sb-bar-fill{background:#176b55!important}' + '.sb-worst-seller{border-color:#fecaca!important}' + '.sb-worst-seller .sb-bar-fill.worst{background:linear-gradient(90deg,#f87171,#dc2626)!important}' + '.sb-worst-seller .sb-bar-track{background:#fee2e2!important}' + '.sb-worst-seller .sb-bar-rank.worst{background:#fee2e2;color:#991b1b;border:1px solid #fca5a5}' +
      ...
      '.sb-status-icon.progress{background:#ecfdf5;color:#176b55}' +
      '.sb-status-icon.success{background:#dcfce7;color:#15803d}' +
      '.sb-status-icon.error{background:#fee2e2;color:#b91c1c}' +
      '.sb-status-main{font-size:14px;font-weight:700;color:#1f2a25;margin:0 0 4px}' +
      '.sb-status-detail{font-size:12px;color:#6e7d76;margin:0 0 12px;word-break:break-word}' +
      '.sb-status-track{height:8px;background:#e8f0ec;border-radius:999px;overflow:hidden;margin:8px 0 6px}' +
      '.sb-status-fill{height:100%;background:linear-gradient(90deg,#176b55,#22c55e);border-radius:999px;transition:width .25s ease}' +
      '.sb-status-card b{display:block;font-size:13px;color:#176b55;margin-bottom:4px}' +
