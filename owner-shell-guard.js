 ...
 * Complements the Owner sidebar/CSS shell already in main. It prevents Owner
 * top navigation from calling core-app's full legacy render() after the modern
 * Sales/Stock/ERP views have mounted. Non-owner roles are untouched.
 */
(function () {
  'use strict';
  ...
  function visibleIds(id){ return GROUPS[id]?GROUPS[id].slice():[id]; }
  ...
  function setVisibility(id){
    ...
    Array.prototype.forEach.call(document.querySelectorAll('#tabs .tab[data-tab]'),function(button){
  ...
  function ensureStock(){
    ...
    // stock-reconcile-v2 owns its own MutationObserver. This child mutation only
    // wakes that renderer after programmatic navigation; it performs no write.
