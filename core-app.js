(function () {
  ...
  function render() {
    ...
    $("pembelian").innerHTML =
      ...
      '<div class="card"><h2>Grafik Pembelian Bulanan</h2><div style="display:flex;align-items:flex-end;gap:10px;height:210px">'+(purchaseMonths.map(function(m){var v=purchaseMonth[m]||0,h=purchaseMax?Math.max(6,Math.round(v/purchaseMax*160)):6;return '<div style="flex:1;text-align:center;height:100%;display:flex;flex-direction:column;justify-content:flex-end;align-items:center"><div class="small">'+rp(v)+'</div><div data-purchase-height="'+h+'"></div><div class="small">'+m+'</div></div>';}).join("")||'<div class="small">Upload file pembelian untuk menampilkan grafik.</div>')+'</div></div>'+
