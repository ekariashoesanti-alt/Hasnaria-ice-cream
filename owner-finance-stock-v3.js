/* Compatibility shim: Owner Finance uses stable v6 with Purchase-basis expense reporting; Stock uses canonical Stock Control v3. */
(function(){
  'use strict';
  ...
  load('hasnaria-finance-purchase-basis-v1-js','/finance-purchase-basis-v1.js?v=2');
