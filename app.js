(function () {
  ...
  var STOCK = '/stock-monitor.js?v=12';
  ...
  function fixStockLayout() {
    ...
    st.textContent =
      '#stok .stk-form{display:grid!important;grid-template-columns:minmax(0,1.05fr) minmax(0,.82fr) minmax(0,.82fr) minmax(0,1.12fr) minmax(0,1.12fr) minmax(120px,.78fr)!important;column-gap:12px!important;row-gap:0!important;align-items:start!important;width:100%!important;max-width:100%!important;overflow:visible!important;background:transparent!important;border:0!important;border-radius:0!important;padding:0!important;}' +
