...
(function () {
  ...
  async function render() {
    ...
    card.innerHTML = '<div class="sb-card-head"><div><h3>Rata-rata Jam Penjualan Harian</h3><span>' + esc(ym) + ' · rata-rata transaksi per jam</span></div></div><div class="sb-hourly-body"><div class="sb-empty-chart">Memuat data jam transaksi…</div></div>';
