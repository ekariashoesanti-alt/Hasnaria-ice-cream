  ...
  async function run(fileOrFiles,ctx){
    ...
    try{
      ...
      try{
        ...
        /* SAFE REPLACE: upsert by brand + external_transaction_id. Never delete an entire
           date range before the new rows are safely stored. This prevents data loss if an
           upload is interrupted and also makes re-imports update the existing transaction. */
